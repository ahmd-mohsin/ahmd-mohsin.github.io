...
function Eq({ children }: { children: ReactNode }) {
  return (
    <div className="my-7 border-l-2 border-[#8C1515]/60 pl-5 py-1 font-mono text-[14px] text-[#6f1010] leading-relaxed">
      {children}
    </div>
  );
}
