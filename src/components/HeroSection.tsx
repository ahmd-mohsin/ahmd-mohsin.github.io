      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pt-28 pb-24 w-full">
          ...
          <div className="text-center md:text-left">
            ...
            <motion.p
              ...
              className="font-mono text-[11px] uppercase tracking-[0.3em] text-[#4b5563] mb-7"
            >
            ...
            <motion.h1
              ...
              className="text-5xl md:text-7xl lg:text-[5.25rem] font-bold tracking-[-0.02em] leading-[1.06] text-[#8C1515] mb-7"
            >
            ...
            <motion.p
              ...
              className="italic text-sm text-[#4b5563] leading-relaxed max-w-xl mb-6"
            >
              Co-advised by{" "}
              <a
                ...
                className="text-[#8C1515] hover:text-[#6f1010] transition-colors underline underline-offset-4 decoration-[#d4d4d8]/40 hover:decoration-[#8C1515] font-medium"
              >
                Dr. Emily Fox
              </a>{" "}
              and{" "}
            ...
            >
              <p className="text-sm font-semibold leading-relaxed text-[#262626]">
            ...
            >
              {[
                ...
                <a
                  ...
                  className="text-[#262626] hover:text-[#8C1515] transition-colors duration-200"
                >
                  {item.icon}
                </a>
              ))}

              <span className="w-px h-5 bg-[#d4d4d8]/30" />

              <a
                href="/Masters.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="font-mono text-[11px] font-semibold text-[#262626] hover:text-[#8C1515] transition-colors border border-[#d4d4d8]/30 hover:border-[#8C1515]/50 bg-[#f4f4f5]/60 px-3 py-1.5"
              >
                CV ↗
              </a>
